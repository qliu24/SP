...
def predict_scale_score_dense(category, extractor, set_type):
    ...
    scale_save_file = os.path.join(Score_dir, 'scale_{}_{}_dense.pickle'.format(category, set_type))
...
if __name__=='__main__':
    ...
    for category in all_categories2[3:4]:
        predict_scale_score_dense(category, extractor, set_type='test')